define(["require", "exports"], function (require, exports) {
	...
	exports.autocompletes = {
		"Function": {
			...
			"scriptsfolder.createfile()": {
				"insertText": "scriptsfolder.createfile(${1:name})",
				"documentation": {
					value: [
						"```lua", "function scriptsfolder.createfile(name: string, folderName: string)\n  -> string", "```",
						"",
						"Creates a file with that name inside the folder selected.",
						"",
						'```',
					].join("\n")
				},
			...
			"scriptsfolder.deletefile()": {
				"insertText": "scriptsfolder.deletefile(${1:name})",
				"documentation": {
					value: [
						"```lua", "function scriptsfolder.deletefile(name: string, folderName: string)\n  -> string", "```",
						"",
						"Deletes a file with that name inside the folder selected.",
						"",
						'```',
					].join("\n")
				},
